<x-layout>
  <div>
    <x-page-title>Repeat Data Gabung KBIH</x-page-title>
  </div>

  <div class="rounded-lg shadow-lg shadow-black mt-4 p-4">
    <form id="formPendaftaran" action="{{ route('gabung-haji.storeRepeatData') }}" method="POST" enctype="multipart/form-data"> 
      @csrf
      ...
      <div class="w-full grid grid-cols-1 md:grid-cols-3 gap-7">
        ...
        <div>
          ...
          <div class="grid grid-cols-1 md:grid-cols-1 gap-2">
            <div>
              <label class="block mb-2 text-sm font-medium leading-6 text-[#099AA7]">Nama Panggilan</label>
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              <label class="block mb-2 text-sm font-medium text-[#099AA7]">
            ...
            <div>
              <label class="block mt-1 mb-2 text-sm font-medium text-[#099AA7]">No HP 2</label>
        ...
        <div class="relative">
          ...
          <div>
            <label class="block mt-2 mb-2 text-sm font-medium text-[#099AA7]">
          ...
          <div>
            <label for="alamat_domisili" class="block mt-3 mb-2 text-sm font-medium text-[#099AA7]">
          ...
          <div class=" shadow-slate-400">
            <label for="provinsi_domisili" class="mt-2 mb-1 block text-sm font-medium leading-6 text-[#099AA7]">
              Provinsi <span class="text-red-500 text-lg">*</span>
            </label>
          ...
          <div class=" shadow-slate-400">
            ...
            <select name="kota_domisili" id="kota_domisili" required required data-selected="{{ $customer->kota_domisili ?? '' }}"
            class="w-full text-gray-900 bg-white border border-gray-300 rounded-lg text-sm px-3 py-2 focus:ring-blue-300 focus:border-blue-500">
        ...
        <div class="relative">
          <div class="grid grid-cols-1 md:grid-cols-2 gap-2">
            <div>
              ...
              <input type="number" name="no_spph" id="no_spph" placeholder="Nomor SPPH" value="{{ old('no_spph') }}" class="block w-full rounded-md border-0 p-2 text-gray-900 shadow-slate-400 ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-indigo-600 text-sm leading-6 
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-2 mt-2">
            <div>
              <label class="block mb-2 text-sm font-medium leading-6 text-[#099AA7]">
                Nama Bank <span class="text-red-500 text-lg">*</span>
              </label>
              <input type="text" name="nama_bank" id="nama_bank" required value="{{ old('nama_bank') }}" 
                placeholder="Bank/Jumlah Setoran" class="mb-3 block w-full rounded-md border-0 p-2 text-gray-900  ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-indigo-600 text-sm leading-6" />
            </div>
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-2 mb-3">
            ...
            <div>
              <label class="block mt-1 mb-2 text-sm font-medium leading-6 text-[#099AA7]">
                Tahun Keberangkatan
              </label>
