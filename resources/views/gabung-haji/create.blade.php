<x-layout>
  <div>
    <x-page-title>Tambah Data Gabung Haji</x-page-title>
  </div>
      ...
      <div class="w-full grid grid-cols-1 md:grid-cols-3 gap-7">
        ...
        <div>
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-2">
            <div>
              ...
              <input type="number" name="no_spph" required placeholder="No SPPH"
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-2">
            ...
            <div>
              ...
              <input type="text" name="depag" required placeholder="Depag"
              class="mb-3 block w-full rounded-md border-0 p-2 text-gray-900 shadow-md ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-indigo-600 text-sm leading-6" />
            </div>
          </div>
        ...
        <div class="relative">
          ...
          <div>
            ...
            class="mb-4 block p-2.5 w-full shadow-md text-sm text-black bg-gray-100 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500" 
            placeholder="Write your thoughts here..."></textarea>
          </div>
