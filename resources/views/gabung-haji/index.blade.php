          ...
          <tr class="bg-white border-b border-[#099AA7] hover:bg-gray-100">
            ...
            <td class="px-6 py-4 text-center">
              <div class="inline-flex items-center space-x-2">
                <a href="/gabung-haji/{{ $daftar->id }}/edit" class="font-medium text-blue-600 hover:underline">
                ...
                <span>|</span>
                <form action="/gabung-haji/{{ $daftar->id }}" method="POST" class="deleteForm inline-block">
                  @method('DELETE')
                  @csrf
