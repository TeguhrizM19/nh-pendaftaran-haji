        ...
        <div class="p-4 md:p-5">
          <form action="/keberangkatan" method="POST" class="space-y-4">
            ...
            <div> 
              ...
              <input type="text" name="manasik" class="manasik bg-gray-100 border-2 border-gray-500 text-gray-900 text-sm rounded-lg focus:ring-[#099AA7] focus:border-[#099AA7] block w-full p-2.5" placeholder="Masukkan Nominal Manasik" />
            ...
            <div>
              ...
              <input type="text" name="operasional" class="operasional bg-gray-100 border-2 border-gray-500 text-gray-900 text-sm rounded-lg focus:ring-[#099AA7] focus:border-[#099AA7] block w-full p-2.5" placeholder="Masukkan Nominal Operasional" />
            ...
            <div>
              ...
              <input type="text" name="dam" class="dam bg-gray-100 border-2 border-gray-500 text-gray-900 text-sm rounded-lg focus:ring-[#099AA7] focus:border-[#099AA7] block w-full p-2.5" placeholder="Masukkan Nominal Dam" />
