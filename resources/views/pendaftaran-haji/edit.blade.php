      ...
      <div class="w-full grid grid-cols-1 md:grid-cols-3 gap-7">
        ...
        <div>
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-2 mt-4">
            <div>
              ...
              <input type="text" name="bank" id="bank" value="{{ old('bank', $daftar_haji->bank) }}" placeholder="Bank/Jumlah Setoran" 
        ...
        <div class="relative">
          ...
          <div>
            ...
            <textarea id="alamat_ktp" rows="2" name="alamat_ktp"  class="block p-2.5 w-full text-sm text-black bg-white rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 uppercase"
            placeholder="Alamat KTP...">{{ old('alamat_ktp', $customer->alamat_ktp) }}</textarea>
          </div>
      
          <!-- Provinsi KTP -->
          <div class="mt-4">
            <label for="provinsi_ktp" class="mb-2 block text-sm font-medium text-[#099AA7]">Provinsi KTP</label>
          ...
          <!-- Kota KTP -->
          <div class="mt-4">
              <label for="kota_ktp" class="mb-2 block text-sm font-medium text-[#099AA7]">Kota</label>
          ...
          <!-- Kecamatan KTP -->
          <div class="mt-4">
            <label for="kecamatan_ktp" class="mb-2 block text-sm font-medium text-[#099AA7]">Kecamatan</label>
          ...
          <!-- Kelurahan KTP -->
          <div class="mt-4">
            <label for="kelurahan_ktp" class="mb-2 block text-sm font-medium text-[#099AA7]">Kelurahan</label>
          ...
          <div class="mt-4">
            ...
            <textarea id="alamat_domisili" rows="2" name="alamat_domisili" 
              class="block p-2.5 w-full text-sm text-black bg-white rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500" placeholder="Alamat Domisili...">
              {{ old('alamat_domisili', $customer->alamat_domisili) }}
            </textarea>
          </div>
      
          <!-- Provinsi Domisili -->
          <div class="mt-4">
            <label for="provinsi_domisili" class="mb-2 block text-sm font-medium text-[#099AA7]">Provinsi</label>
          ...
          <!-- Kota Domisili -->
          <div class="mt-4">
            <label for="kota_domisili" class="mb-2 block text-sm font-medium text-[#099AA7]">Kota</label>
          ...
          <!-- Kecamatan Domisili -->
          <div class="mt-4">
            <label for="kecamatan_domisili" class="mb-2 block text-sm font-medium text-[#099AA7]">Kecamatan</label>
          ...
          <!-- Kelurahan Domisili -->
          <div class="mt-4">
            <label for="kelurahan_domisili" class="mb-2 block text-sm font-medium text-[#099AA7]">Kelurahan</label>
