        ...
        <div>
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-2 mt-4">
            <div>
              ...
              <input type="text" name="bank" id="bank" value="{{ old('bank') }}" placeholder="Bank/Jumlah Setoran" class="mb-3 block w-full rounded-md border-0 p-2 text-gray-900  ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-indigo-600 text-sm leading-6" />
            </div>
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-2 mt-4">
            <div>
              ...
              <input type="number" name="bpjs" id="bpjs" value="{{ old('bpjs') }}" placeholder="No BPJS" class="block w-full rounded-md border-0 p-2 text-gray-900 shadow-slate-400 ring-insetring-gray-300 focus:ring-2 focus:ring-inset focus:ring-indigo-600 text-sm leading-6 
        ...
        <div class="relative">
          ...
          <div class="flex gap-4 mt-4">
            <div class="w-full ">
              ...
              <select name="kelurahan_ktp" id="kelurahan_ktp" required data-selected="{{ $customer->kelurahan_ktp ?? '' }}"
                class="w-full text-gray-900 bg-white border border-gray-300 rounded-lg text-sm px-3 py-2 focus:ring-blue-300 focus:border-blue-500">
