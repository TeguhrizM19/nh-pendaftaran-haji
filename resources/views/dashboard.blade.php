<x-layout>
  <div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mt-5 mb-5">
      <div>
        <!-- Pelunasan Haji -->
        <div class="rounded-lg mb-5 items-center w-full border border-gray-100 bg-white p-4 shadow-gray-500 shadow-lg transition hover:shadow-lg hover:shadow-[#099AA7] sm:p-6">
          <h3 class="mt-0.5 text-lg font-medium text-gray-900">
            Pelunasan Haji
          </h3>
          <div class="flex gap-5 mt-3">
        ...
        <!-- Pelunasan Manasik -->
        <div class="rounded-lg mb-5 items-center w-full border bg-white p-4 shadow-gray-500 shadow-lg transition hover:shadow-lg hover:shadow-[#099AA7] sm:p-6">
          <h3 class="mt-0.5 text-lg font-medium text-gray-900">
            Pelunasan Manasik
          </h3>
          <div class="flex gap-5 mt-3">
