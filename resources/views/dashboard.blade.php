    ...
    {{-- <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mt-5 mb-5">
      ...
      <div class="rounded-lg items-center w-full border border-gray-100 bg-white p-4 shadow-gray-500 shadow-lg transition hover:shadow-lg hover:shadow-[#099AA7] sm:p-6">
        ...
        <div class="flex gap-5 mt-3">
          ...
          <p class="mt-2 line-clamp-3 font-medium text-[#099AA7]">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mt-5 mb-5">
      ...
      <div class="rounded-lg items-center w-full border border-gray-100 bg-white p-4 shadow-gray-500 shadow-lg transition hover:shadow-lg hover:shadow-[#099AA7] sm:p-6">
        ...
        <div class="flex gap-5 mt-3">
          ...
          <p class="flex items-center gap-1 font-medium text-[#099AA7] text-2xl"> 
            <span class="font-bold text-3xl">{{ $pelunasanHaji }}</span> Jama'ah
          </p>
        </div>
      </div>
      {{-- <div class="rounded-lg items-center w-full border border-gray-100 bg-white p-4 shadow-gray-500 shadow-lg transition hover:shadow-lg hover:shadow-[#099AA7] sm:p-6">
        ...
        <div class="flex gap-5 mt-3">
          ...
          <p class="flex items-center gap-1 font-medium text-[#099AA7] text-2xl"> 
            <span class="font-bold text-3xl">{{ $belumMelunasiHaji }}</span> Jama'ah Haji
          </p>
        </div>
      </div> --}}
      ...
      <div class="rounded-lg items-center w-full border bg-white p-4 shadow-gray-500 shadow-lg transition hover:shadow-lg hover:shadow-[#099AA7] sm:p-6">
        ...
        <div class="flex gap-5 mt-3">
          ...
          <p class="flex items-center gap-1 font-medium text-[#099AA7] text-2xl"> 
            <span class="font-bold text-3xl">{{ $pelunasanManasik }}</span> Jama'ah
          </p>
        </div>
      </div>
      {{-- <div class="rounded-lg items-center w-full border bg-white p-4 shadow-gray-500 shadow-lg transition hover:shadow-lg hover:shadow-[#099AA7] sm:p-6">
        ...
        <div class="flex gap-5 mt-3">
          ...
          <p class="flex items-center gap-1 font-medium text-[#099AA7] text-2xl"> 
            <span class="font-bold text-3xl">{{ $belumMelunasiManasik }}</span> Jama'ah Manasik
          </p>
        </div>
      </div> --}}
    </div>
